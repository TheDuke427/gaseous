...
php-fpm83 -F -R -y /dev/null -d listen=127.0.0.1:9000 -d pm=dynamic -d pm.max_children=5 -d pm.start_servers=2 -d pm.min_spare_servers=1 -d pm.max_spare_servers=3 &
